    ...
    export default {
      ...
      methods: {
        getInstalaciones() {
            ...
            axios.get("http://localhost:80/tecnico/"+this.id_tecnico+"/equipos/3").then((res) => {
        ...
        deleteItemConfirm () {
          ...
          console.log(this.editedItem.id_equipo)
          axios
        ...
        save () {
          if (this.editedIndex > -1) {
            ...
            this.editedItem.altura_sensor = parseInt(this.editedItem.altura_sensor)
